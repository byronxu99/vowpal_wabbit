...
void parse_slates_example_json(const VW::label_parser& lbl_parser, bool hash_all, bool chain_hash,
...
extern template void parse_slates_example_json<true>(const VW::label_parser& lbl_parser, bool hash_all, bool chain_hash,
    VW::multi_ex& examples, char* line, size_t length, VW::example_factory_t example_factory,

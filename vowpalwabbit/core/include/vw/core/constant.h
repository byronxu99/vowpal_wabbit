...
constexpr std::array<VW::namespace_index, 17> SPECIAL_NAMESPACES{
    {DEFAULT_NAMESPACE, WILDCARD_NAMESPACE, WAP_LDF_NAMESPACE, HISTORY_NAMESPACE, CONSTANT_NAMESPACE,
        NN_OUTPUT_NAMESPACE, AUTOLINK_NAMESPACE, NEIGHBOR_NAMESPACE, AFFIX_NAMESPACE, SPELLING_NAMESPACE,
        CONDITIONING_NAMESPACE, DICTIONARY_NAMESPACE, NODE_ID_NAMESPACE, BASELINE_ENABLED_MESSAGE_NAMESPACE,
        CCB_SLOT_NAMESPACE, CCB_ID_NAMESPACE, IGL_FEEDBACK_NAMESPACE}};

...
void read_line_json_s(const VW::label_parser& lbl_parser, bool hash_all, bool chain_hash,
...
{
  VW::parsers::json::read_line_json<audit>(lbl_parser, hash_all, chain_hash, reuse_mem, ldict, examples, line, length,
      std::move(example_factory), logger, ignore_features, dedup_examples);
}
...
extern template void VW::read_line_json_s<true>(const VW::label_parser& lbl_parser, bool hash_all, bool chain_hash,
    VW::label_parser_reuse_mem* reuse_mem, const VW::named_labels* ldict, VW::multi_ex& examples, char* line,
    size_t length, example_factory_t example_factory, VW::io::logger& logger,
    std::unordered_map<std::string, std::set<std::string>>* ignore_features,
    const std::unordered_map<uint64_t, VW::example*>* dedup_examples);
extern template void VW::read_line_json_s<false>(const VW::label_parser& lbl_parser, bool hash_all, bool chain_hash,
    VW::label_parser_reuse_mem* reuse_mem, const VW::named_labels* ldict, VW::multi_ex& examples, char* line,
    size_t length, example_factory_t example_factory, VW::io::logger& logger,
    std::unordered_map<std::string, std::set<std::string>>* ignore_features,
    const std::unordered_map<uint64_t, VW::example*>* dedup_examples);

...
{
template <bool audit>
void parse_slates_example_json(const VW::label_parser& lbl_parser, bool hash_all,
...
extern template void parse_slates_example_json<true>(const VW::label_parser& lbl_parser, bool hash_all,
    bool chain_hash, VW::multi_ex& examples, char* line, size_t length,
    VW::example_factory_t example_factory, const std::unordered_map<uint64_t, VW::example*>* dedup_examples);
extern template void parse_slates_example_json<false>(const VW::label_parser& lbl_parser, bool hash_all,
    bool chain_hash, VW::multi_ex& examples, char* line, size_t length,
    VW::example_factory_t example_factory, const std::unordered_map<uint64_t, VW::example*>* dedup_examples);
